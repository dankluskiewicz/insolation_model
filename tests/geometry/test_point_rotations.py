...
@pytest.mark.parametrize(
    "rotation_function", [_rotate_points_around_z_axis, _rotate_points_around_x_axis]
)
...
def test_x_axis_rotation_converts_directions_correctly(
    input_vector, output_vector, angle
):
